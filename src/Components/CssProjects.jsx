            ...
            <div>
                ...
                <div className="row">
                    ...
                    <div className="col-md-6 mb-2">
                        <ProjectCard
                            img={`${import.meta.env.BASE_URL}/images/css_cform.png`}
                            title='Contact Form'
                    ...
                    <div className="col-md-6 mb-2">
                        <ProjectCard
                            img={`${import.meta.env.BASE_URL}/images/tesla.png`}
                            title='Blog Project'
                            text='A dynamic video background that can be paused or played with the click of a
                                button. This project highlights the integration of HTML,
                                CSS, and JavaScript to create an interactive and engaging user experience.'
                    ...
                    <div className="col-md-6 mb-2">
                        <ProjectCard
                            img={`${import.meta.env.BASE_URL}/images/html_table.png`}
                    ...
                    <div className="col-md-6 mb-2">
                        <ProjectCard
                            img={`${import.meta.env.BASE_URL}/images/music.png`}
                            title='Music Site'
                            text='A dynamic video background that can be paused or played with the click of a
                                button. This project highlights the integration of HTML,
                                CSS, and JavaScript to create an interactive and engaging user experience.'
                    ...
                    <div className="col-md-6 mb-2">
                        <ProjectCard
                            img={`${import.meta.env.BASE_URL}/images/flexbox1.png`}
                    ...
                    <div className="col-md-6 mb-2">
                        <ProjectCard
                            img={`${import.meta.env.BASE_URL}/images/flexbox2.png`}
                    ...
                    <div className="col-md-6 mb-2">
                        <ProjectCard
                            img={`${import.meta.env.BASE_URL}/images/myblog.png`}
